...
0% is wrong in that you can land on it. But that would then make it correct in saying it's the wrong answer. Does that make it right, wrong, or somehow both?
...
[comments]:#(https://vis.chat/asksirius/asksirius---when_statistics_asks_about_itself---2021-03-14/)
